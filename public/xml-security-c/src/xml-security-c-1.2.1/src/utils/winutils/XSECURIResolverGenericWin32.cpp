 ...
 *
 * $Id: XSECURIResolverGenericWin32.cpp,v 1.1.1.1 2006/08/21 08:15:02 baiqian Exp $
 *
 * $Log: XSECURIResolverGenericWin32.cpp,v $
 * Revision 1.1.1.1  2006/08/21 08:15:02  baiqian
 * no message
 *
