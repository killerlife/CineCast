	...
	namespace mxflib
	{
		...
		//baiqian add: for mxf/ts, I just write a mock UL!, 
		const UInt8 MPEG2TSDescriptor_UL_Data[16] = { 0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0xff, 0xff, 0x52, 0x00 };
		const UL MPEG2TSDescriptor_UL(MPEG2TSDescriptor_UL_Data);
		
#ifdef MPEG3D
		//Add by Jaontolt
		const UInt8 StereoscopicPictureSubDescriptor_UL_Data[16] = { 0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x0c, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x63, 0x00 };
		const UL StereoscopicPictureSubDescriptor_UL(StereoscopicPictureSubDescriptor_UL_Data);
#endif
