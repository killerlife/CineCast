 ...
 *
 *	\version $Id: esp_mpeg2ves.h,v 1.1.1.1 2007/04/03 02:08:42 baiqian Exp $
 *
 */
/*
...
namespace mxflib
{
	...
	protected:
		...
		DataChunkPtr ReadSequenceHeader(FileHandle InFile, UInt32 Stream, UInt64 Count);
		...
		//zhonghong:
		bool SeekIFrame(FileHandle InFile, UInt64 Count);
