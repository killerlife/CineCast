...
: QWidget(parent), pSocket(NULL), bUpdateNetWork(0), bSoftKeypad(false)
...
void Setup::Init()
{
	ui.lineEdit_Frequency->setStyleSheet("QLineEdit{font-size:14px;font-family:'Book Antiqua';}");
	ui.lineEdit_symbol_rate->setStyleSheet("QLineEdit{font-size:14px;font-family:'Book Antiqua';}");
	ui.comboBox_decimals->setStyleSheet("QComboBox{font-size:14px;font-family:'Book Antiqua';}");
	ui.comboBox_DVB->setStyleSheet("QComboBox{font-size:14px;font-family:'Book Antiqua';}");
	ui.comboBox_SPK->setStyleSheet("QComboBox{font-size:14px;font-family:'Book Antiqua';}");
	ui.comboBox_V->setStyleSheet("QComboBox{font-size:14px;font-family:'Book Antiqua';}");
	ui.comboBox_xy->setStyleSheet("QComboBox{font-size:14px;font-family:'Book Antiqua';}");
	ui.label_ip->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_Gateway->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_Gateway_2->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_Gateway_3->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_Netm_mask->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_DNS->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_DNS_2->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_Ip->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_GateWay->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_Remote_3->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_Net_AsK->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_DNS->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_DNS_2->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");

	ui.label_ip_2->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_Gateway_4->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_Netm_mask_2->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_DNS_3->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_DNS_4->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_Ip_2->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_GateWay_2->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_Net_AsK_2->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_DNS_3->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
	ui.lineEdit_DNS_4->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");
...
// 	ui.checkBox_DHCP->setStyleSheet("QCheckBox{font-size:20px;font-family:'Book Antiqua';}");
	ui.lineEdit_Remote_2->setStyleSheet("QLineEdit{font-size:12px;font-family:'Book Antiqua';}");

	ui.radioButtonStatic->setStyleSheet("QRadioButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.radioButtonDhcp->setStyleSheet("QRadioButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.radioButtonStatic_2->setStyleSheet("QRadioButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.radioButtonDhcp_2->setStyleSheet("QRadioButton{font-size:12px;font-family:'Book Antiqua';}");

// 	ui.comboBox_SPK->setEnabled(false);

	ui.pushButton->setStyleSheet("QPushButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.pushButton_2->setStyleSheet("QPushButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.pushButtonApply1->setStyleSheet("QPushButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.pushButtonApply2->setStyleSheet("QPushButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.pushButtonApply2_2->setStyleSheet("QPushButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.pushButton_13->setStyleSheet("QPushButton{font-size:12px;font-family:'Book Antiqua';}");
	ui.label_frequency->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.labe_symbl_rate->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.label_frequency_2->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.labe_symbl_rate_4->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.labe_symbl_rate_5->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.labe_symbl_rate_8->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.labe_symbl_rate_6->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
	ui.labe_symbl_rate_9->setStyleSheet("QLabel{font-size:14px;font-family:'Book Antiqua';}");
// 	ui.labe_symbl_rate_13->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
// 	ui.labe_symbl_rate_12->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
// 	ui.labe_symbl_rate_11->setStyleSheet("QLabel{font-size:12px;font-family:'Book Antiqua';}");
	ui.groupBox_Network_2->setStyleSheet("QGroutBox{font-size:10px;font-family:'Book Antiqua';}");
	ui.groupBox_3->setStyleSheet("QGroutBox{font-size:10px;font-family:'Book Antiqua';}");
	ui.groupBox_4->setStyleSheet("QGroutBox{font-size:10px;font-family:'Book Antiqua';}");

	connecting.load(QString::fromUtf8(":/CineCastUi/Resources/recv.png"));
	connected.load(QString::fromUtf8(":/CineCastUi/Resources/idle.png"));

	ui.pushButton_2->setFocus(Qt::TabFocusReason);
#ifndef FULL_VERSION
...
{
	if(te->timerId() == m_TMS_timer && bSoftKeypad)
	{
		if(ui.lineEdit_Frequency->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Frequency"));
			num.SetNumber(ui.lineEdit_Frequency->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_Frequency->setText(num.GetNumber());
			ui.pushButton_2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_symbol_rate->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Symbol Rate"));
			num.SetNumber(ui.lineEdit_symbol_rate->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_symbol_rate->setText(num.GetNumber());
			ui.pushButton_2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_Remote_2->hasFocus())
		{
			TMS_stop();
			UrlIM url(this);
			url.SetTitle(tr("Remote"));
			url.SetUrl(ui.lineEdit_Remote_2->text());
			if(url.exec() == QDialog::Accepted)
				ui.lineEdit_Remote_2->setText(url.GetUrl());
			ui.pushButton_13->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_Remote_3->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Port"));
			num.SetNumber(ui.lineEdit_Remote_3->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_Remote_3->setText(num.GetNumber());
			ui.pushButton_13->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_Ip->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("IP Address"), true);
			num.SetNumber(ui.lineEdit_Ip->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_Ip->setText(num.GetNumber());
			ui.pushButtonApply1->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_Net_AsK->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Netmask"), true);
			num.SetNumber(ui.lineEdit_Net_AsK->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_Net_AsK->setText(num.GetNumber());
			ui.pushButtonApply1->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_GateWay->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Gateway"), true);
			num.SetNumber(ui.lineEdit_GateWay->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_GateWay->setText(num.GetNumber());
			ui.pushButtonApply1->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_DNS->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("DNS 1"), true);
			num.SetNumber(ui.lineEdit_DNS->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_DNS->setText(num.GetNumber());
			ui.pushButtonApply1->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_DNS_2->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("DNS 2"), true);
			num.SetNumber(ui.lineEdit_DNS_2->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_DNS->setText(num.GetNumber());
			ui.pushButtonApply1->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_Ip_2->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("IP Address"), true);
			num.SetNumber(ui.lineEdit_Ip_2->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_Ip_2->setText(num.GetNumber());
			ui.pushButtonApply2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_Net_AsK_2->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Netmask"), true);
			num.SetNumber(ui.lineEdit_Net_AsK_2->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_Net_AsK_2->setText(num.GetNumber());
			ui.pushButtonApply2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_GateWay_2->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("Gateway"), true);
			num.SetNumber(ui.lineEdit_GateWay_2->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_GateWay_2->setText(num.GetNumber());
			ui.pushButtonApply2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_DNS_3->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("DNS 1"), true);
			num.SetNumber(ui.lineEdit_DNS_3->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_DNS_3->setText(num.GetNumber());
			ui.pushButtonApply2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
		if(ui.lineEdit_DNS_4->hasFocus())
		{
			TMS_stop();
			NumberIM num(this);
			num.SetTitle(tr("DNS 2"), true);
			num.SetNumber(ui.lineEdit_DNS_4->text());
			if(num.exec() == QDialog::Accepted)
				ui.lineEdit_DNS_4->setText(num.GetNumber());
			ui.pushButtonApply2->setFocus(Qt::TabFocusReason);
			TMS_start();
		}
	}
...
#ifndef WIN32
	FILE *fp = fopen("/etc/CineCast/touchkeypad", "rb");
	if(fp)
	{
		char s = '0';
		fread(&s, 1, 1, fp);
...
void Setup::GetRemoteConnectStatus(int i /* = 0 */)
{
	if(i == 0)
	{
		...
		if(pKL->m_pkgHead == 0x7585 && pKL->m_keyID == S_GET_RECEIVE)
		{
			...
			{
				ui.label->setPixmap(connected);
				ui.label->setToolTip(tr("Connected."));
			}
			else
			{
				ui.label->setPixmap(connecting);
				ui.label->setToolTip(tr("Connecting..."));
			}
		}
	}
	else if(i == 1)
