...
// 	ui.treeWidget_HDD_info->setColumnWidth(0, 45);
	ui.treeWidget_HDD_info->setColumnWidth(0, 50);
	ui.treeWidget_HDD_info->setColumnWidth(1, 810);
	ui.treeWidget_HDD_info->setColumnWidth(2, 90);
	ui.treeWidget_HDD_info->setColumnWidth(3, 80);
	ui.treeWidget_HDD_info->setColumnWidth(4, 100);
	ui.treeWidget_HDD_info->setColumnWidth(5, 100);
