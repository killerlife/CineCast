...
private:
	...
	CGetSpace getSpace;
private:
	long long int  m_nProgramSize;  // ĿС
	std::vector<filename> m_oProgramfileList; //Ŀļб 
...
//		checkProgram(m_destDeletePath, tempId);
		...
		if (sIdFile != "")
		{
			cout << "ؼļ id  | describe.ini   ||| sIdFile = " << sIdFile << endl;
