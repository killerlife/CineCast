 ...
 *
 *	\version $Id: index.h,v 1.2 2007/09/20 05:47:13 baiqian Exp $
 *
 */
/*
...
//		IndexEntryMap EssenceOrderEntryMap;
	...
	public:
		...
		~IndexTable() 
		{ 
			if(BaseDeltaCount && BaseDeltaArray) delete[] BaseDeltaArray; 
		};
...
//baiqian add:
		//IndexPosPtr LookupFile(bool& find , MDObjectPtr Segment, Position EditUnit, int SubItem = 0, bool Reorder = true);
		IndexPosPtr LookupFromDataChunk(bool& find , DataChunkPtr indexTableChunk, Position EditUnit, int SubItem = 0, bool Reorder = true);
