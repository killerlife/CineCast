 ...
 *
 *	\version $Id: essence.h,v 1.1.1.1 2007/04/03 02:08:42 baiqian Exp $
 *
 */
/*
...
namespace mxflib
{
	...
	public:
		...
		//baiqian add:
		virtual void SetEncrypt(Encrypt_Base *Enc,UUIDPtr ContextID, Length PlaintextOffset = 0)=0;
...
namespace mxflib
{
	...
	public:
		...
		//this fun must be called before read data;
...
// FIXME: Move to .cpp file!
	...
	public:
		...
		//baiqian: return have write unit number;
		UInt64 getWrited(){ return m_totalWrite;};
	protected:
