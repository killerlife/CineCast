 ...
 *
 *	\version $Id: essence.cpp,v 1.1.1.1 2007/04/03 02:08:42 baiqian Exp $
 *
 */
/*
...
EssenceParser::EssenceParser()
{
	if(!EPListInited)
	{
		...
		//baiqian: add
		EPList.push_back(new MPEG2_TS_EssenceSubParser);
		EPListInited = true;
	}
}
		...
		if(Object->GetUL()->GetValue()[5] == 4)
			{
				...
				//baiqian mod: change 16 to 12
				if( memcmp(Object->GetUL()->GetValue(), EncryptedKey, 12/*16*/) == 0 )
				{
